...
const About = () => {
	return (
		<AboutPage>
			<TextA>
				Originally from Wellington, New Zealand I moved to Melbourne in 2015. I have a background in hospitality
				and have worked as a barista for many number of years, which I have enjoyed thoroughly. Technology and
				creativity has always been passion of mine, as demonstrated by my long term hobbie of visual effects,
				which you can check out
				<Link href="https://vimeo.com/richardsandofx"> here</Link>.
        <br/> <br/>
				In 2019 I started a diploma of IT at Coder Academy where I learnt how to create full stack applications
				using the latest technologies. After graduating I completed an internship at a digital agency, helping
				to develop components for a live web app, under the guidance of a senior developer.
        <br/> <br/>
				Since graduating I have been focusing on developing my skills, especially in the frontend. My current
				tech stack is React, NextJS and Styled components. (Redux,Typescript and GraphQL are also on my list). As well as learning new technologies I aim to improve my fundamentals; HTML, CSS and Javascript. I
    ...
    <br/> <br/>
        I am looking for any opportunities in the field of web development, if you something or know of someone, please get in touch!
			...
			<TextB>
				<h3 style={{ margin: '0' }}>Stuff I'm familiar with:</h3>
